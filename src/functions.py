"""
This file will contain all of the necessary and relevant modules that 
have been created in association with this research. This file, will include functions,
vehicle profiles dedicated for the use of RLS, SGD, and other methods. The first portion 
of this file will contain the functions relevant and needed for Recursive Least Squares (RLS). 

The later portions of this file will contain the rests of the functions and needed stuff for other 
algorithms that will be implemented at a later time. 
"""
...
# Function Solves Individual Parameters:   
...
# Recurisve Least Squares Algorithm: 
"""
